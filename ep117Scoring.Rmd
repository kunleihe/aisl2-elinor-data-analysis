...
## recall items: q1, q2, q3, q4, q6, q7, q8, q9,q13, q14
## transfer items: q5, q10, q11, q12, q15
df_Post117$p117_recall_score = rowSums(df_Post117[, c("q1_soccer_score", "q2_lucky_score", "q3_shirt_score", 
                                                ...
                                                "q8_tight_score", "q9_two_score", "q13_lose_score", "q14_return_score")], 
                               na.rm = TRUE)

df_Post117$p117_transfer_score = rowSums(df_Post117[, c("q5_wall_score", "q10_book_score", 
                                                "q11_skin_score", "q12_mom_score", "q15_grasshopper_cr_score")],
                               na.rm = TRUE)
